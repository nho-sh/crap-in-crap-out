...
(function() {
  var anythingValidator, badSchemaNumber, booleanValidator, functionValidator, guard, guardian, inspectForError, integerValidator, isArray, isDefined, isFloat, isFunction, isInteger, isString, knownValueCheckers, longUuidRegex, notAFunction, notAGoodSchema, numberValidator, parseRegex, querystring, schemaDuplicateValues, schemaParser, shortUuidRegex, stringValidator, uuidValidator, valueChecker,
    indexOf = [].indexOf,
  ...
  numberValidator = function(parsedSchema) {
    return function(good) {
      if (good === null) {
        if (parsedSchema.optional) {
          return false;
